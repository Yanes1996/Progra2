package segundo_ejemplo;

public class Indice {
    
    public static void main(String args[]) {
    
        int masa = 53; // Masa en kilogramos
        double estatura = 1.75; // Estatura en metros
        double IMC = masa/Math.pow(estatura, 2); /* Calcular el índice de masa corporal */
